...
<div class=row>
    <div class="col-lg-6 col-sm-12">
        <div class="row">
            ...
            <div class="col-12">
                ...
                <input type="date" class="form-control" name="gegevensGeboorte" value="<?php print $gegevens->geboorte ?>"
                       required>
                <?php echo form_label('Telefoon:', 'gegevensTelefoon'); ?>
                <input type="text" class="form-control" name="gegevensTelefoon" value="<?php echo $gegevens->telefoon ?>"
                       required>
    ...
    <div class="col-lg-6 col-sm-12">
        ...
        <input style="width:auto" type="text" class="form-control" name="gegevensGemeente"
               value="<?php echo $gegevens->adres->gemeente ?>" required>
        <?php echo form_label('Postcode:', 'gegevensPostcode'); ?>
        <input style="width:auto" type="text" class="form-control" name="gegevensPostcode"
