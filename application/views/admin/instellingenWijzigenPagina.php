    ...
    <?php
        ...
        foreach ($instellingen as $instelling) {
            echo '<div class="form-group row">';
                ...
                echo form_input(array('name' => $instelling->naam, 'id' => $instelling->naam, 'placeholder' => str_replace(".",",",$instelling->waarde), 'type' => 'number', 'size' => '30', 'class' => 'form-control col-sm-12 col-md-2', 'step' => "0.01"));
            echo '</div>';
        }
